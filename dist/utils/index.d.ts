...
export declare const isWheelEvent: <T extends HTMLElement>(e: import("react").TouchEvent<T> | import("react").MouseEvent<T, MouseEvent> | import("react").WheelEvent<T>) => e is import("react").WheelEvent<T>;
